...
function App() {
  ...
  // 'home' | 'login' | 'signup' | 'onboarding' | 'generator'
  ...
  // Logout handler that also resets app state
  ...
  // ---------- INJECT GLOBAL STYLES (keyframes + fonts) ----------
  useEffect(() => {
  ...
  const DarkModeToggle = ({ size = 40 }) => (
    <button
      ...
      style={{
        ...
        height: `${size}px`,
        borderRadius: "50%",
        background: darkMode ? theme.gold + "22" : theme.forest + "12",
  ...
  const BrandPanel = ({ heading, sub }) => (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <h1 style={{ fontSize: "1.7rem", fontWeight: 700, letterSpacing: "-0.5px", margin: 0 }}>
          Planora
        </h1>
        <p style={{ marginTop: "6px", fontSize: "0.78rem", opacity: 0.8, letterSpacing: "1.5px" }}>
          FLOOR PLANS · INTERIORS · IDEAS
        </p>
      </div>

      <div style={{ position: "relative", zIndex: 1 }}>
        <h2 style={{ fontSize: "2.8rem", lineHeight: 1.1, margin: 0, fontWeight: 600 }}>
          {heading}
        </h2>
        <p style={{ marginTop: "20px", maxWidth: "380px", opacity: 0.85, lineHeight: 1.6 }}>
          {sub}
        </p>
      </div>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "48px" }}>
          <div style={{ width: "100%", maxWidth: "400px" }}>
            ...
            {authError && (
              <p style={{ color: theme.terracotta, fontSize: "0.85rem", margin: "0 0 12px" }}>
                {authError}
              </p>
            )}
            ...
            <p style={{ marginTop: "32px", textAlign: "center", color: theme.muted, fontSize: "0.88rem" }}>
              ...
              <span
                ...
                style={{ color: theme.terracotta, fontWeight: 600, cursor: "pointer" }}
              >
                Sign up
              </span>
            </p>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "48px" }}>
          <div style={{ width: "100%", maxWidth: "400px" }}>
            ...
            <p style={{ color: theme.muted, marginBottom: "28px", fontSize: "0.95rem" }}>
              Join Planora and design your home in minutes.
            </p>
  ...
  // =====================================================
  // ONBOARDING PAGE — Layout preferences (after login)
  // =====================================================
  if (page === "onboarding" && user) {
    // Elegant line-art icons — match the editorial, earthy aesthetic
    const iconProps = {
      width: 38,
      height: 38,
      viewBox: "0 0 40 40",
    ...
    const houseTypes = [
      {
        ...
        icon: (
          <svg {...iconProps}>
            ...
            <path d="M12 34V20m4 14V20m4 14V20m4 14V20m4 14V20" />
            <path d="M6 16h28" />
          </svg>
        ),
      },
      {
        id: "apartment",
        label: "Apartment",
        desc: "Urban & efficient",
        icon: (
          <svg {...iconProps}>
            <rect x="9" y="5" width="22" height="30" rx="1" />
            <path d="M14 11h3M23 11h3M14 17h3M23 17h3M14 23h3M23 23h3" />
            <path d="M17 35v-6h6v6" />
          </svg>
        ),
      },
      {
        id: "bungalow",
        label: "Bungalow",
        desc: "Single-storey comfort",
        icon: (
          <svg {...iconProps}>
            <path d="M5 20l15-12 15 12" />
            <path d="M8 18v16h24V18" />
      ...
      },
      {
        id: "townhouse",
        label: "Townhouse",
        desc: "Multi-level living",
        icon: (
          <svg {...iconProps}>
            <path d="M4 34h32" />
            <path d="M6 34V16l7-6 7 6v18" />
            <path d="M20 34V12l7-5 7 5v22" />
            <path d="M10 34v-8h6v8" />
            <path d="M25 34v-9h5v9" />
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg {...iconProps}>
            ...
            <path d="M6 24h28" />
            <path d="M11 24v-6a3 3 0 013-3h12a3 3 0 013 3v6" />
            <path d="M9 30v3M31 30v3" />
          </svg>
        ),
      },
      {
        id: "duplex",
        label: "Duplex",
        desc: "Two-floor flexibility",
        icon: (
          <svg {...iconProps}>
            <path d="M5 18l15-11 15 11" />
            <path d="M8 16v18h24V16" />
            <path d="M8 25h24" />
            <path d="M14 25v-5h5v5M25 34v-6h5v6" />
          </svg>
        ),
      },
      {
    ...
    const styles = [
      ...
      },
      {
        id: "scandinavian",
        label: "Scandinavian",
        desc: "Light, warm, natural",
        icon: (
          <svg {...iconProps}>
            <path d="M20 5v30" />
            <path d="M20 12l-5-5M20 12l5-5" />
            <path d="M20 20l-7-7M20 20l7-7" />
            <path d="M20 28l-5-5M20 28l5-5" />
          </svg>
        ),
      },
      {
      ...
      },
      {
        id: "bohemian",
        label: "Bohemian",
        desc: "Eclectic & layered",
        icon: (
          <svg {...iconProps}>
            <path d="M20 35V12" />
            <path d="M20 12c0-4 3-7 7-7 0 4-3 7-7 7z" />
            <path d="M20 18c0-3-2-5-5-5 0 3 2 5 5 5z" />
            <path d="M20 24c0-3 2-5 5-5 0 3-2 5-5 5z" />
            <path d="M20 30c0-3-2-5-5-5 0 3 2 5 5 5z" />
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg {...iconProps}>
            <path d="M6 34h28" />
            <path d="M8 34V14h24v20" />
            <path d="M6 14l14-8 14 8" />
            <path d="M13 34V18M20 34V18M27 34V18" />
          </svg>
        ),
      },
    ];
    ...
    const Card = ({ active, onClick, children }) => (
      <div
        onClick={onClick}
        className="planora-card"
        style={{
          padding: "22px",
          borderRadius: "16px",
          background: active ? theme.ivory : theme.card,
          border: active ? `2px solid ${theme.terracotta}` : `1px solid ${theme.line}`,
          cursor: "pointer",
          boxShadow: active
    ...
    return (
      <div
        ...
        style={{
          minHeight: "100vh",
          background: `linear-gradient(180deg, ${theme.cream} 0%, ${theme.ivory} 100%)`,
          fontFamily: fontBody,
          color: theme.ink,
      ...
      >
        ...
        <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "48px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <h1 style={{ fontSize: "1.5rem", fontWeight: 700, letterSpacing: "-0.5px", margin: 0, fontFamily: fontDisplay }}>
              Planora
            </h1>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto 40px" }}>
          ...
          <p style={{ color: theme.muted, fontSize: "1.05rem", maxWidth: "600px", lineHeight: 1.6 }}>
            Choose your house type and preferred style — we'll generate floor plans tailored to
            ...
            {houseTypes.map((h) => (
              <Card key={h.id} active={houseType === h.id} onClick={() => setHouseType(h.id)}>
                <div
                  style={{
                    marginBottom: "12px",
                    color: houseType === h.id ? theme.terracotta : theme.forest,
                    transition: "color 0.3s ease, transform 0.3s ease",
                    transform: houseType === h.id ? "translateY(-1px)" : "none",
                    display: "flex",
                  }}
                >
                  {h.icon}
        ...
        <section style={{ maxWidth: "1100px", margin: "0 auto 48px" }}>
          ...
          <p style={{ color: theme.muted, fontSize: "0.9rem", margin: "0 0 20px" }}>
            Pick the aesthetic that feels like home.
          </p>
          <div
            style={{
              display: "grid",
            ...
            {styles.map((s) => (
              <Card key={s.id} active={style === s.id} onClick={() => setStyle(s.id)}>
                <div
                  style={{
                    marginBottom: "12px",
                    color: style === s.id ? theme.terracotta : theme.forest,
                    transition: "color 0.3s ease, transform 0.3s ease",
                    transform: style === s.id ? "translateY(-1px)" : "none",
                    display: "flex",
                  }}
                >
                  {s.icon}
        ...
        {/* DETAILS — conditional by house type */}
        <section style={{ maxWidth: "1100px", margin: "0 auto 32px" }}>
          ...
          <p style={{ color: theme.muted, fontSize: "0.9rem", margin: "0 0 20px" }}>
            {houseType
              ...
              : "Select a house type above to see relevant questions."}
          </p>
          <div
            style={{
              display: "grid",
          ...
          >
            ...
            {/* VILLA / BUNGALOW — floors, plot area, garden, parking */}
            ...
            {/* APARTMENT / STUDIO — floor number, carpet area, balcony */}
            ...
            {/* TOWNHOUSE / DUPLEX — floors, carpet area, parking */}
        ...
        <section style={{ maxWidth: "1100px", margin: "0 auto 48px" }}>
          ...
          <p style={{ color: theme.muted, fontSize: "0.9rem", margin: "0 0 20px" }}>
            Upload a plot or apartment blueprint if you have one. We'll use it as a starting point.
          </p>
          <label
            ...
            style={{
              ...
              padding: "40px 24px",
              borderRadius: "14px",
              border: `2px dashed ${blueprintFile ? theme.terracotta : theme.line}`,
              textAlign: "center",
              cursor: "pointer",
          ...
          >
            ...
            {blueprintFile ? (
              <div>
                ...
                <div style={{ fontWeight: 600, color: theme.ink, marginBottom: "4px" }}>
                  {blueprintFile.name}
                </div>
                <div style={{ fontSize: "0.82rem", color: theme.muted }}>
                  {(blueprintFile.size / 1024).toFixed(1)} KB · Click to change
                </div>
                <button
                  type="button"
                  onClick={(e) => {
              ...
              <div>
                ...
                <div style={{ fontSize: "0.82rem", color: theme.muted }}>
                  PNG, JPG, PDF, DWG, or DXF · Max 10MB
                </div>
              </div>
            )}
          </label>
  ...
  // =====================================================
  // PROFILE PAGE — user info + saved designs
  // =====================================================
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <h1 style={{ margin: 0, fontSize: "1.5rem", fontWeight: 700, fontFamily: fontDisplay, letterSpacing: "-0.5px" }}>
              Planora <span style={{ color: theme.muted, fontWeight: 400, fontStyle: "italic" }}>· Profile</span>
            </h1>
          </div>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              fontWeight: 600,
              color: theme.cream,
              border: `4px solid ${theme.cream}20`,
          ...
          <div style={{ position: "relative", zIndex: 1, flex: 1, minWidth: "240px" }}>
            ...
            <p style={{ margin: "0 0 20px", opacity: 0.8, fontSize: "0.95rem" }}>
              {user?.email}
            </p>
            <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
              <div>
                ...
                <div style={{ fontSize: "0.72rem", opacity: 0.7, letterSpacing: "1px", textTransform: "uppercase" }}>
                  Saved designs
                </div>
              </div>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", flexWrap: "wrap", gap: "12px" }}>
            <h3 style={{ margin: 0, fontSize: "1.3rem", fontFamily: fontDisplay, fontWeight: 600 }}>
              Your preferences
            </h3>
            <button
              className="planora-btn"
          ...
          >
            {[
              ...
              <div key={i}>
                <div style={{ fontSize: "0.68rem", color: theme.muted, letterSpacing: "1.5px", fontWeight: 600, marginBottom: "4px" }}>
                  {item.label}
                </div>
                <div
                  style={{
                    ...
                    fontFamily: fontDisplay,
                    fontWeight: 500,
                    textTransform: ["HOUSE TYPE", "STYLE"].includes(item.label) ? "capitalize" : "none",
                    color: item.value ? theme.ink : theme.muted,
                  }}
                >
                  {item.value || "—"}
                </div>
          ...
          {description && (
            <div style={{ marginTop: "24px", paddingTop: "20px", borderTop: `1px solid ${theme.line}` }}>
              <div style={{ fontSize: "0.68rem", color: theme.muted, letterSpacing: "1.5px", fontWeight: 600, marginBottom: "6px" }}>
                YOUR NOTES
              </div>
              <p style={{ margin: 0, color: theme.ink, lineHeight: 1.6, fontSize: "0.95rem", fontStyle: "italic" }}>
                "{description}"
              </p>
            </div>
          )}
        ...
        <div className="anim-fadeUp" style={{ animationDelay: "0.2s" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
            ...
            <span style={{ color: theme.muted, fontSize: "0.9rem" }}>
              {savedDesigns.length} of 10 free slots used
            </span>
          </div>
          ...
          {savedDesigns.length === 0 ? (
            ...
            >
              ...
              <h4 style={{ fontFamily: fontDisplay, fontWeight: 500, fontSize: "1.3rem", margin: "0 0 8px" }}>
                No saved designs yet
              </h4>
              <p style={{ color: theme.muted, margin: "0 0 20px", fontSize: "0.95rem" }}>
                Generate your first layout and hit save — it'll show up here.
              </p>
              <button
                className="planora-btn"
                onClick={() => setPage("generator")}
            ...
            >
              {savedDesigns.map((d, i) => (
                <div
                  key={d.id}
                  className="planora-card anim-scaleIn"
                  style={{
                    background: theme.card,
                    padding: "24px",
                    borderRadius: "18px",
                  ...
                  <div style={{ display: "flex", gap: "6px", marginBottom: "12px", flexWrap: "wrap" }}>
                    ...
                    {d.style && (
                      <span
                        style={{
                          fontSize: "0.7rem",
                          background: `${theme.terracotta}15`,
    ...
    const features = [
      {
        ...
        desc: "Describe your life. Get a layout that actually fits how you live — not a template.",
      },
      {
        icon: "◈",
        title: "50+ Style Presets",
        desc: "From minimalist Scandi to maximalist bohemian — switch aesthetics in one click.",
      },
      {
        icon: "◉",
        title: "Room-by-Room",
        desc: "Fine-tune every space. Adjust dimensions, furniture, light, and flow.",
      },
      {
        icon: "✺",
        title: "3D Preview",
        desc: "Walk through your plan in interactive 3D before a single wall goes up.",
      },
      {
        icon: "⬡",
        title: "Export & Share",
        desc: "Download print-ready PDFs or share with your architect in a click.",
      },
      {
        icon: "✧",
        title: "Mood Boards",
        desc: "Pin materials, colors, and inspiration — all tied to your floor plan.",
      },
    ];
      ...
      >
        ...
        <nav
          ...
          style={{
            ...
            top: 0,
            zIndex: 100,
            background: `${theme.cream}dd`,
            backdropFilter: "blur(12px)",
            WebkitBackdropFilter: "blur(12px)",
            borderBottom: `1px solid ${theme.line}60`,
          }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <svg width="26" height="26" viewBox="0 0 40 40">
            ...
            <h1 style={{ fontSize: "1.4rem", fontWeight: 700, letterSpacing: "-0.5px", margin: 0, fontFamily: fontDisplay }}>
              Planora
            </h1>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "32px" }}>
            <a href="#features" className="planora-link" style={{ color: theme.ink, textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>
              Features
            </a>
            <a href="#how" className="planora-link" style={{ color: theme.ink, textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>
              How it works
            </a>
            <a href="#stories" className="planora-link" style={{ color: theme.ink, textDecoration: "none", fontSize: "0.9rem", fontWeight: 500 }}>
              Stories
            </a>
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  boxShadow: `0 6px 20px ${theme.terracotta}50`,
                  fontFamily: fontBody,
                }}
              >
                Sign up
            ...
            <div>
              <div
                ...
                style={{
                  ...
                  gap: "8px",
                  padding: "8px 16px",
                  background: `${theme.forest}10`,
                  border: `1px solid ${theme.forest}30`,
                  borderRadius: "999px",
                  fontSize: "0.78rem",
                  fontWeight: 600,
                  color: theme.forest,
              ...
              <h2
                className="hero-title anim-fadeUp"
                style={{
                  fontSize: "5.2rem",
                  lineHeight: 0.98,
                  margin: 0,
              ...
              >
                Design <br />
                <em style={{ fontStyle: "italic", fontWeight: 400 }}>without</em> <br />
              ...
              >
                The AI-driven floor planner and home decoration studio for the next generation of
                homeowners. Sketch. Style.{" "}
                <em style={{ color: theme.terracotta, fontStyle: "normal", fontWeight: 600 }}>
                  Ship your dream home.
                </em>
              </p>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    cursor: "pointer",
                    boxShadow: `0 14px 32px ${theme.forest}50`,
                    fontFamily: fontBody,
                  }}
                >
              ...
              >
                <div>
                  <div style={{ fontSize: "1.8rem", fontWeight: 600, fontFamily: fontDisplay, color: theme.forest }}>12k+</div>
                  <div style={{ fontSize: "0.78rem", color: theme.muted, letterSpacing: "0.5px", textTransform: "uppercase" }}>Homes designed</div>
                </div>
                <div style={{ width: "1px", background: theme.line }} />
                <div>
                  <div style={{ fontSize: "1.8rem", fontWeight: 600, fontFamily: fontDisplay, color: theme.forest }}>4.9★</div>
                  <div style={{ fontSize: "0.78rem", color: theme.muted, letterSpacing: "0.5px", textTransform: "uppercase" }}>User rating</div>
                </div>
                <div style={{ width: "1px", background: theme.line }} />
                <div>
                  <div style={{ fontSize: "1.8rem", fontWeight: 600, fontFamily: fontDisplay, color: theme.forest }}>60s</div>
                  <div style={{ fontSize: "0.78rem", color: theme.muted, letterSpacing: "0.5px", textTransform: "uppercase" }}>Avg generation</div>
                </div>
              </div>
            </div>
            ...
            >
              <div
                style={{
                  ...
                  height: "80%",
                  borderRadius: "50%",
                  background: `radial-gradient(circle, ${theme.gold}30 0%, transparent 60%)`,
                  top: "10%",
                  left: "10%",
        ...
        <section
          style={{
            ...
            color: theme.cream,
            overflow: "hidden",
            borderTop: `1px solid ${theme.forest}`,
            borderBottom: `1px solid ${theme.forest}`,
          }}
        >
          <div className="marquee-track">
            {[...marqueeItems, ...marqueeItems, ...marqueeItems].map((item, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", padding: "0 36px", fontSize: "1.4rem", fontFamily: fontDisplay, fontStyle: "italic", fontWeight: 400, opacity: 0.85 }}>
                {item}
                <span style={{ marginLeft: "36px", color: theme.terracotta, fontSize: "1.8rem" }}>✦</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="features" style={{ padding: "120px 48px", maxWidth: "1280px", margin: "0 auto" }}>
          <div className="scroll-reveal" style={{ textAlign: "center", marginBottom: "72px" }}>
            <div style={{ fontSize: "0.78rem", color: theme.terracotta, letterSpacing: "2px", fontWeight: 600, marginBottom: "16px" }}>
              ✦ WHAT YOU GET
            </div>
            <h2 style={{ fontSize: "3.2rem", fontFamily: fontDisplay, fontWeight: 500, margin: 0, letterSpacing: "-1px", lineHeight: 1.1 }}>
              Every tool your home <br />
              <em style={{ fontStyle: "italic", color: theme.terracotta }}>deserves.</em>
            </h2>
          </div>
          <div
            style={{
          ...
          >
            {features.map((f, i) => (
              <div
                key={i}
                className="planora-card scroll-reveal"
                style={{
                  padding: "36px 32px",
                  background: theme.card,
                  borderRadius: "20px",
              ...
              >
                <div
                  style={{
                    ...
                    height: "56px",
                    borderRadius: "14px",
                    background: `linear-gradient(135deg, ${theme.forest}15 0%, ${theme.terracotta}15 100%)`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: "1.6rem",
                ...
                <h3 style={{ fontSize: "1.25rem", margin: "0 0 10px", fontFamily: fontDisplay, fontWeight: 600 }}>
                  {f.title}
                </h3>
        ...
        <section
          ...
          style={{
            padding: "120px 48px",
            background: `linear-gradient(180deg, ${theme.ivory} 0%, ${theme.cream} 100%)`,
            ...
            >
              {steps.map((s, i) => (
                ...
                >
                  ...
                  <h3 style={{ fontSize: "1.35rem", margin: "0 0 10px", fontFamily: fontDisplay, fontWeight: 600 }}>
                    {s.title}
                  </h3>
        ...
        <section id="stories" style={{ padding: "120px 48px", maxWidth: "1280px", margin: "0 auto" }}>
          <div className="scroll-reveal" style={{ textAlign: "center", marginBottom: "72px" }}>
            ...
            <h2 style={{ fontSize: "3.2rem", fontFamily: fontDisplay, fontWeight: 500, margin: 0, letterSpacing: "-1px", lineHeight: 1.1 }}>
              Loved by <em style={{ fontStyle: "italic", color: theme.terracotta }}>dreamers</em> <br />
              and builders alike.
            </h2>
          </div>
          <div
          ...
          >
            {testimonials.map((t, i) => (
              <div
                ...
                className="planora-card scroll-reveal"
                style={{
                  background: i === 1 ? theme.forest : theme.card,
                  color: i === 1 ? theme.cream : theme.ink,
                  padding: "40px 32px",
                  borderRadius: "20px",
              ...
              >
                <div
                  style={{
                    ...
                    fontFamily: fontDisplay,
                    lineHeight: 0.5,
                    color: i === 1 ? theme.gold : theme.terracotta,
                    marginBottom: "16px",
                  }}
                >
                  "
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                ...
                <em style={{ fontStyle: "italic", color: theme.gold }}>one click away.</em>
              </h2>
              <p style={{ color: `${theme.cream}cc`, fontSize: "1.1rem", maxWidth: "520px", margin: "0 auto 40px", lineHeight: 1.6 }}>
                Join thousands of homeowners designing their perfect space with Planora. No credit
                card, no commitment — just pure creation.
              </p>
              <button
                className="planora-btn"
                onClick={() => setPage("signup")}
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  boxShadow: `0 20px 50px ${theme.ink}50`,
                  fontFamily: fontBody,
                }}
              >
                Start designing free →
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <span style={{ color: theme.muted, fontSize: "0.85rem", marginLeft: "12px" }}>
              © {new Date().getFullYear()} — Designed for dreamers.
            </span>
          </div>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <h1 style={{ margin: 0, fontSize: "1.5rem", fontWeight: 700, fontFamily: fontDisplay, letterSpacing: "-0.5px" }}>
            Planora <span style={{ color: theme.muted, fontWeight: 400, fontStyle: "italic" }}>· Studio</span>
          </h1>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <span style={{ color: theme.muted, fontSize: "0.9rem", marginRight: "6px" }}>
            Hi, <strong style={{ color: theme.ink }}>{user?.displayName || user?.email}</strong>
          </span>
          <button
            className="planora-btn"
            onClick={() => setDarkMode(!darkMode)}
      ...
      >
        ...
        {[
          ...
          <div key={i} style={{ position: "relative", zIndex: 1 }}>
            <div style={{ fontSize: "0.68rem", letterSpacing: "1.5px", opacity: 0.7, fontWeight: 600 }}>
              {item.label}
            </div>
            <div
              style={{
                ...
                color: item.value ? theme.cream : `${theme.cream}60`,
              }}
            >
              {item.value || "—"}
            </div>
      ...
      <div
        ...
        style={{
          ...
          padding: "36px",
          borderRadius: "20px",
          boxShadow: "0 4px 30px rgba(20,17,15,0.06)",
          border: `1px solid ${theme.line}`,
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <h3 style={{ margin: 0, fontSize: "1.4rem", fontFamily: fontDisplay, fontWeight: 600 }}>
              Design Generator
            </h3>
            <p style={{ margin: "4px 0 0", color: theme.muted, fontSize: "0.9rem" }}>
              Hit generate and watch your layout come to life.
            </p>
          </div>
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <button
              ...
              onClick={() => {
                ...
                if (bed <= 1) setRooms(["Bedroom", "Hall", "Kitchen", "Bathroom"]);
                else if (bed <= 3) setRooms(["Bedroom", "Bedroom", "Hall", "Kitchen", "Bathroom"]);
                else setRooms(["Bedroom", "Bedroom", "Bedroom", "Bedroom", "Hall", "Kitchen", "Bathroom", "Study"]);
                setSuggestion(
                  `A ${style || "modern"} ${houseType || "home"} layout with ${
                    bedrooms || "your"
                  } bedrooms — optimized for flow and natural light.`
                );
              }}
              style={{
                background: `linear-gradient(135deg, ${theme.forest} 0%, ${theme.forestDeep} 100%)`,
                ...
                fontFamily: fontBody,
                fontSize: "0.95rem",
                boxShadow: `0 12px 28px ${theme.forest}40`,
              }}
            >
              ✦ Generate Design
            </button>
        ...
        {/* Rooms grid with entrance animation */}
        {rooms.length > 0 && (
          <div>
            <div style={{ fontSize: "0.75rem", color: theme.muted, letterSpacing: "1.5px", fontWeight: 600, marginBottom: "14px" }}>
              YOUR LAYOUT · {rooms.length} ROOMS
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
              {rooms.map((room, i) => (
                <div
                  key={`${room}-${i}-${rooms.length}`}
                  className="planora-card anim-scaleIn"
                  style={{
                    padding: "22px 32px",
                    border: `2px solid ${theme.forest}`,
                    background: `linear-gradient(135deg, #fff 0%, ${theme.ivory} 100%)`,
                    borderRadius: "14px",
                    fontWeight: 600,
                    fontFamily: fontDisplay,
                    color: theme.ink,
                ...
                >
                  <div style={{ fontSize: "0.68rem", color: theme.muted, fontWeight: 600, letterSpacing: "1px", marginBottom: "4px", fontFamily: fontBody }}>
                    0{i + 1}
                  </div>
                  {room}
                </div>
        ...
        {suggestion && (
          <div
            ...
            style={{
              marginTop: "28px",
              padding: "20px 24px",
              background: `linear-gradient(135deg, ${theme.terracotta}10 0%, ${theme.gold}10 100%)`,
          ...
          >
            ...
            <div>
              <div style={{ fontSize: "0.72rem", color: theme.terracotta, letterSpacing: "1.5px", fontWeight: 700, marginBottom: "4px" }}>
                AI SUGGESTION
              </div>
              <p style={{ margin: 0, color: theme.ink, lineHeight: 1.5, fontSize: "0.95rem" }}>
                {suggestion}
              </p>
            </div>
          </div>
